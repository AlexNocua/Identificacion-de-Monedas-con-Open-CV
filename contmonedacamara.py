...
while True:
    ...
    if imagen_A6 is not None:
        ...
        for c_2 in contorno2:
            ...
            if area<9950 and area>8000:
                font=cv2.FONT_HERSHEY_SIMPLEX
                cv2.putText(imagen_A6, "Moneda de 50 centimos",(x-40,y+150) , font, 0.75, (0,255,0),2)
                suma1=suma1+0.2
            ...
            #Prueba con moneda de un real.
            if area<13000 and area>9500:
                font=cv2.FONT_HERSHEY_SIMPLEX
                cv2.putText(imagen_A6, "Moneda de un real",(x-40,y+150) , font, 0.75, (0,255,0),2)
